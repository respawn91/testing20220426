...
SELECT id, model, price FROM phones
...
SELECT * FROM phones 
WHERE manufacturer = 'LG' OR manufacturer = 'Samsung' OR manufacturer = 'Motorola'

SELECT * FROM phones 
WHERE manufacturer IN ('LG', 'Samsung', 'Motorola')

SELECT * FROM phones 
WHERE manufacturer NOT IN ('LG', 'Samsung', 'Motorola')